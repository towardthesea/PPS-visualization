...
filename = './ppsTaxelsFiles/taxels1D_learned_l_hand.ini'
%filename = './ppsTaxelsFiles/taxels1D_45cmRF_skinV2_learned_l_hand.ini'
%filename = './ppsTaxelsFiles/taxels1D_45cmRF_skinV2_perfect_l_hand.ini'
delimiter = {' ','(',')'};
startRow = 8;
